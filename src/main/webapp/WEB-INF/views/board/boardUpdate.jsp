                            ...
                            <div class="row">
                            	<div class="col-12 col-md-6">
                                    <div class="form-group">
                                        <input type="text" class="form-control" name="board_num" id="contact-name" placeholder="글번호">
                                    </div>
                                </div>
                                <div class="col-12 col-md-6">
                                    <div class="form-group">
                                        <input type="email" class="form-control" name="board_category" id="contact-email" placeholder="카테고리">
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="form-group">
                                        <input type="text" class="form-control" name="title" id="contact-subject" placeholder="Subject">
                                    </div>
                                </div>
                                <div class="col-12 col-md-6">
                                    <div class="form-group">
                                        <input type="text" class="form-control" name="user_name" id="contact-name" placeholder="글쓴이">
                                    </div>
                                </div>
                                <div class="col-12 col-md-6">
                                    <div class="form-group">
                                        <input type="email" class="form-control" name="write_date" id="contact-email" placeholder="글쓴시간">
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="form-group">
                                        <textarea class="form-control" name="content" id="message" cols="30" rows="10" placeholder="글내용"></textarea>
                                    </div>
                                </div>
                                <div class="col-12">
                                    <button type="submit" class="btn alazea-btn mt-15">수정</button>
                                    <button type="submit" class="btn alazea-btn mt-15">삭제</button>
                                    <button type="submit" class="btn alazea-btn mt-15">목록</button>
                                </div>
                            </div>
                        </form>
                    </div>
