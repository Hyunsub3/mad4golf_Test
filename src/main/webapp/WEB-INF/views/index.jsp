                                ...
                                <ul>
                                    ...
                                    <li><a href="#">Pages</a>
                                        <ul class="dropdown">
                                            ...
                                            <li><a href="${pageContext.request.contextPath }/product/listAll?category=Wedge">Wedge</a>
                                           <!--      <ul class="dropdown">
                                                    <li><a href="portfolio.html">Portfolio</a></li>
                                                    <li><a href="single-portfolio.html">Portfolio Details</a></li>
                                                </ul> -->
                                            </li>
                                            <li><a href="${pageContext.request.contextPath }/product/listAll?category=Putter">Putter</a>
                                            <!--     <ul class="dropdown">
                                                    <li><a href="blog.html">Blog</a></li>
                                                    <li><a href="single-post.html">Blog Details</a></li>
                                                </ul> -->
                                            </li>
                                            <li><a href="${pageContext.request.contextPath }/product/listAll?category=Etc">Etc</a></li>
                                        </ul>
                                    </li>
                                    <li><a href="shop.html">Shop</a></li>
                                    <li><a href="portfolio.html">Portfolio</a></li>
