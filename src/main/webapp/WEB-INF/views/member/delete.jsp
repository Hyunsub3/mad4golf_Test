...
<body>
    ...
    <header class="header-area">
        ...
        <!-- ***** Navbar Area ***** -->
        <div id="sticky-wrapper" class="sticky-wrapper" style="height: 90px;"><div class="alazea-main-menu" style="width: 1350px;">
                        ...
                        <form action="#" method="post">
                            <div class="row">
                                <div class="col-12 mb-4">
                                    ...
                                    <input type="email" class="form-control" id="email_address" value="" readonly>
                                </div>
                                <div class="col-12 mb-4">
                ...
                <div class="col-12 col-lg-4">
                    <div class="checkout-content">
                        <div class="checkout-btn mt-30">
                            <a href="#" class="btn alazea-btn w-100">탈퇴하기</a>
                        </div>
                    </div>
                </div>
            </div>
