...
<body>
    ...
    <header class="header-area">
        ...
        <!-- ***** Navbar Area ***** -->
        <div id="sticky-wrapper" class="sticky-wrapper" style="height: 70px;"><div class="alazea-main-menu" style="width: 861px;">
...
Copyright ©<script>document.write(new Date().getFullYear());</script>20222022 All rights reserved | This template is made with <i class="fa fa-heart-o" aria-hidden="true"></i> by <a href="https://colorlib.com" target="_blank">Colorlib</a>
<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
    ...
    <!-- Active js -->
    <script src="js/active.js"></script><a id="scrollUp" href="#top" style="position: fixed; z-index: 2147483647; display: none;"><i class="fa fa-angle-up"></i></a><div role="log" aria-live="assertive" aria-relevant="additions" class="ui-helper-hidden-accessible"></div><div role="log" aria-live="assertive" aria-relevant="additions" class="ui-helper-hidden-accessible"></div>
